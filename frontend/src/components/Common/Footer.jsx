      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div>
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            >
              <TbBrandMeta className="h-6 w-6 hover:text-gray-600" />
            </a>
            <a
              href="https://www.facebook.com"
              target="_blank"
              ...
              className="hover:text-gray-300"
            >
              <IoLogoInstagram className="h-6 w-6 hover:text-gray-600" />
            </a>
            <a
              href="https://www.facebook.com"
              target="_blank"
              ...
              className="hover:text-gray-300"
            >
              <RiTwitterXLine className="h-5 w-5 hover:text-gray-600" />
            </a>
          </div>
